...
public class WeeklyLoginAdapter extends RecyclerView.Adapter<WeeklyLoginAdapter.MyViewHolder>  {
    ...
    String dtStart;
    Date date;
    public WeeklyLoginAdapter(Activity activity, List<Weeklybean3> productList) {
